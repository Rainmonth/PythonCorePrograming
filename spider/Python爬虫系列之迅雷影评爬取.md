...
## 摘要
本文利用urllib、lxml对迅雷影评的天天精评模块进行了爬取，难度较低。IDE：PyCharm，Python版本：Python3.7

## 数据源分析

目标网页地址为：[天天精评](http://movie.xunlei.com/reviews/excellentreviews)
...
- 项目运行环境Python3.X
- 运行项目之前请确保已经安装了对应的库
- 把偶才能json数据是，请确保`reviews.json`文件存在且路径正确